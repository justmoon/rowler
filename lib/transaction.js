...
Transaction.prototype.put = function(keyPath, args)
{
  ...
  _.each(tuples, function(tuple){
    ...
    // TODO: Find a way to pass this error back into the regular chain of events
    self.tr.put(packedKey, packedValue, function (err) {
      if (err) {
        console.error('Rowler, dangling error on put: ' + err);
      }
    });
